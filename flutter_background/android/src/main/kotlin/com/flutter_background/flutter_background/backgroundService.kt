...
class BackgroundService : Service(),LifecycleDetector.Listener{
    ...
    override fun onCreate() {
        super.onCreate()
        val notification = BackgroundNotification.buildForegroundNotification(this)
        startForeground(BackgroundNotification.NOTIFICATION_ID_BACKGROUND_SERVICE, notification)
    ...
    companion object {
        ...
        // }
        fun startService(context: Context, event: String) {
            Log.e("aaa","aaa")
            val intent = Intent(context, BackgroundService::class.java).apply {
                putExtra(KEY_CALLBACK_RAW_HANDLE, callbackRawHandle)
            }
